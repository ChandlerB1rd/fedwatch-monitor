...
## Chart
```{raw} html
<iframe src="../../_static/ChandlerB1rd--fedwatch_monitor/fedwatch_latest_forecast.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: </p>
```
[Full Screen Chart](../download_chart/ChandlerB1rd--fedwatch_monitor/fedwatch_latest_forecast.html)
...
| Seasonal Adjustment    |                                     |
| Units                  | Probability (%)                                                  |
| HTML Chart             | [HTML](../download_chart/ChandlerB1rd--fedwatch_monitor/fedwatch_latest_forecast.html)    |
...
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [fed_funds_futures](../dataframes/ChandlerB1rd--fedwatch_monitor/fed_funds_futures.md)                                       |
| Sources                        |                                           |
| Providers                      |                                         |
| Provider Links                 |                                    |
...
- [ChandlerB1rd/fedwatch_monitor:fedwatch_latest_forecast](../../charts/ChandlerB1rd--fedwatch_monitor.fedwatch_latest_forecast.md)
...
|---------------------------------|--------------------------------------------------------|
| Pipeline ID                     | [ChandlerB1rd/fedwatch_monitor](../../index.md)              |
...
| Date of Last Code Update        | 2026-09-26 12:53:48           |
| OS Compatibility                | Windows, Linux, macOS |
| Linked Dataframes               |  [ChandlerB1rd/fedwatch_monitor:fed_funds_futures](../dataframes/ChandlerB1rd--fedwatch_monitor/fed_funds_futures.md)<br>  |
