...
:maxdepth: 1
:caption: Notebooks 📖
30-Day Fed Funds Futures Data from Databento <cb/notebooks/ChandlerB1rd--fedwatch_monitor/01_fed_funds_futures_data>
Replicating the CME FedWatch Tool <cb/notebooks/ChandlerB1rd--fedwatch_monitor/02_fedwatch_replication>
```
...
cb/dataframes/ChandlerB1rd--fedwatch_monitor/fed_funds_futures.md
```
...
| Linked Dataframes               |  [ChandlerB1rd/fedwatch_monitor:fed_funds_futures](cb/dataframes/ChandlerB1rd--fedwatch_monitor/fed_funds_futures.md)<br>  |
